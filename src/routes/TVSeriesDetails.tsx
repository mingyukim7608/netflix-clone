...
import { useTVSeriesDetailsQuery } from "../API";
...
export default function TVSeriesDetails() {
  ...
  const tvSeriesId = params.tvSeriesId as string;
  const tvSeriesDetailsQuery = useTVSeriesDetailsQuery(tvSeriesId);
  const { data } = tvSeriesDetailsQuery;
